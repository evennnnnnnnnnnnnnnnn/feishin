...
import { YoutubeImportSettings } from '/@/renderer/features/settings/components/general/youtube-import-settings';
...
export const GeneralTab = memo(() => {
    ...
    const sections = useMemo(() => {
        const baseSections = [
            ...
            { component: YoutubeImportSettings, key: 'youtubeImport' },
        ];
