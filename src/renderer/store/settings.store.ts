...
const LyricsSettingsSchema = z.object({
    ...
    enableWordLookup: z.boolean().optional(),
    fetch: z.boolean(),
    follow: z.boolean(),
    followScrollAlignment: z.number(),
    furiganaBindingsVisible: z.boolean().optional(),
    kanjiPickerFontSize: z.number().optional(),
    kanjiPickerOpacity: z.number().optional(),
    kanjiPickerShowMeanings: z.boolean().optional(),
    kanjiPickerWidth: z.number().optional(),
...
const initialState: SettingsState = {
    ...
    lyrics: {
        ...
        kanjiPickerFontSize: 14,
        kanjiPickerOpacity: 100,
        kanjiPickerShowMeanings: true,
        kanjiPickerWidth: 340,
        lineLeadTimeMs: 800,
